...
function update(){
  ...
  // r>=17: 赤道の遠心力が重力に追いつき地表がちぎれ始める(惑星が保てない)→人口0
  const breakup=r>=17;
  const rotExtreme=r<0.05||breakup;
  ...
  if(breakup){line='たいへん!赤道のものが宇宙へ飛んでいっちゃう!';face='dizzy';}
  ...
  setFace(face);
  if(breakup)whyRot.textContent='🔎 赤道の遠心力が重力に追いついた!地表がちぎれて宇宙へ飛び出す限界。惑星のかたちを保てないので、人口予測は0だよ';
